...
router.post ('/:id/payment',     ...requireAdmin, ctrl.idParamValidator, ctrl.logPaymentValidator,   ctrl.logPayment);
router.post ('/:id/call',        ...requireAdmin, ctrl.idParamValidator,                             ctrl.recordCall);
